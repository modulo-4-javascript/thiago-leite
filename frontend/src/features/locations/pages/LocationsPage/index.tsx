...
import { Alert, App as AntDesignApp, Dropdown, Empty } from 'antd'
...
import { LocationFormModal, type LocationFormMode, type LocationFormValues } from '../../components/LocationFormModal'
  ...
  return [
    ...
    },
    {
      ...
      render: (status: LocationDetails['status']) => (
        <LocationStatusTag $status={status}>{getLocationStatusLabel(status)}</LocationStatusTag>
      ),
    },
    {
      title: 'Equip.',
